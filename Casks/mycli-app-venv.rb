...
cask "mycli-app-venv" do
  ...
  # Asset naming convention observed from bundle script: mycli-<arch>-<version>-<arch>.tar.gz
  # Example: mycli-arm64-0.1.2-arm64.tar.gz
  url "https://github.com/naga-nandyala/mycli-app/releases/download/v#{version}/mycli-#{arch}-#{version}-#{arch}.tar.gz"
